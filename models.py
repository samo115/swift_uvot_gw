...
class Target(models.Model):
    ...
    :param gwname: The GW this target is associated e.g. S190930t.
    :type name: str
    ...
    name = models.CharField(
        max_length=100, default='', verbose_name='Name1', help_text='The name of this target Barnard\'s star.',
        unique=True
    )
    ...
    gwname = models.CharField(
        max_length=100, default='', verbose_name='Name', help_text='The GW name this target is associated with e.g. S190930t.',
        unique=True
    )    
